  ...
  <div>
    ...
    <div class="container">
      <div class="row  justify-content-between">
        ...
        <!-- titre Sneakers -->
        <h1 class="order-1">streetwear supreme</h1>
      </div>
    </div>
...
<script>
  ...
  export default {
    ...
    created() {
      this.axios
        .get("http://localhost:3000/produit/marque/supreme/streetwear")
        .then((res) => {
    ...
    methods: {
      ...
      order: function () {
        this.axios
          .get("http://localhost:3000/produit/order0/supreme/streetwear")
          .then((res) => {
            this.produits = res.data.produits;
          })
          .catch((err) => {
      ...
      prix: function () {
        this.axios
          .get("http://localhost:3000/produit/prix0/supreme/streetwear")
          .then((res) => {
            this.produits = res.data.produits;
          })
          .catch((err) => {
      ...
      prix1: function () {
        this.axios
          .get("http://localhost:3000/produit/prix00/supreme/streetwear")
          .then((res) => {
            this.produits = res.data.produits;
          })
          .catch((err) => {
